 ...
 */
final class Version20191203114814 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, polymere VARCHAR(255) NOT NULL, methode VARCHAR(255) NOT NULL, masterbatch INT NOT NULL, mfi VARCHAR(255) NOT NULL, quantite INT NOT NULL, complement LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
